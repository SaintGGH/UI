		...
		['Function'] = {
			['Toggle'] = {
				...
				['True'] = {
					...
					['Toggle Value'] = Color3.fromRGB(255, 78, 78),
				},
				['False'] = {
			...
			['Slider'] = {
				...
				['Slider Bar Value'] = Color3.fromRGB(255, 78, 78),
...
ScreenGui.Name = "AnityX by Saint"
...
function Library:Window(p)
	...
	function Tabs:Tab(p)
		...
		function Func:Keybind(p)
			...
			ToggleValue_1.BackgroundColor3 = Color3.fromRGB(40, 40, 40)
			...
			Frame_1.AnchorPoint = Vector2.new(1, 0.5)
			Frame_1.BackgroundColor3 = Color3.fromRGB(255, 78, 78)
			Frame_1.BorderColor3 = Color3.fromRGB(0,0,0)
			Frame_1.BorderSizePixel = 0
			Frame_1.Position = UDim2.new(1, 0,0.5, 0)
